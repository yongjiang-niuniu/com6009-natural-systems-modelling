...
The agent-based model is described as using the module's lecture eco-lab structure. The PDF retains its bibliography and attribution; course teaching materials are not presented here as original student code. The [submission record](reports/submission_record.json) and [preservation notes](docs/MODELS_AND_REPRODUCIBILITY.md#preservation-checks) document the unchanged report. The Overleaf project “自然系统” was checked again on 10 September 2026: its three-page PDF is byte-identical to the submitted report (SHA-256 `85a99558bfe9e290e0bae2bab2f6715ac706649fbe485ed51a82f412dc636fb7`). One canonical copy is retained. Later archive and documentation commits do not recreate its original development history.
